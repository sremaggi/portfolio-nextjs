...
const Navbar = () => {
  ...
  return (
    <nav className=" text-white flex justify-between items-center p-4 relative">
      <Link href="/" className="text-xl md:text-3xl font-bold f1">SRF.dev</Link>
      ...
      <div className={`fixed top-0 right-0 h-full z-10  w-64 transform transition-transform duration-150 ease-in-out ${isOpen ? "translate-x-1/4 bg-zinc-950/95 md:bg-none " : "translate-x-full"} md:relative md:translate-x-0 md:flex md:items-center md:w-auto f1`}>
